...
describe('Change', () => {
  ...
  xtest('change for 6 cents with 3 coins', () => {
    const change = new Change();
    const result = change.calculate([1, 3, 4], 6);
  ...
  xtest('error xtesting for change smaller than the smallest of coins', () => {
    const change = new Change();
  ...
  xtest('error xtesting if no combination can add up to target', () => {
    const change = new Change();
